#pragma checksum "C:\Users\zach\Documents\Visual Studio 2015\Projects\SoundBoardApp\SoundBoardApp\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "2F4B4D707D42A239B74283C612F5D66D"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace SoundBoardApp
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj4_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::SoundBoardApp.Model.MenuItem dataRoot;
            ...
            {
                 global::SoundBoardApp.Model.MenuItem data = args.NewValue as global::SoundBoardApp.Model.MenuItem;
                 if (args.NewValue != null && data == null)
                 {
                    throw new global::System.ArgumentException("Incorrect type passed into template. Based on the x:DataType global::SoundBoardApp.Model.MenuItem was expected.");
                 }
            ...
            public int ProcessBindings(global::Windows.UI.Xaml.Controls.ContainerContentChangingEventArgs args)
            {
                ...
                switch(args.Phase)
                {
                    case 0:
                        nextPhase = -1;
                        this.SetDataRoot(args.Item as global::SoundBoardApp.Model.MenuItem);
                ...
                this.Update_((global::SoundBoardApp.Model.MenuItem) args.Item, 1 << (int)args.Phase);
                return nextPhase;
            }
            ...
            public void SetDataRoot(global::SoundBoardApp.Model.MenuItem newDataRoot)
            {
                this.dataRoot = newDataRoot;
            }

            // Update methods for each path node used in binding steps.
            private void Update_(global::SoundBoardApp.Model.MenuItem obj, int phase)
            {
                if (obj != null)
                {
            ...
            private void Update_Category(global::SoundBoardApp.Model.SoundCategory obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
        ...
        private class MainPage_obj10_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::SoundBoardApp.Model.Sound dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            private bool removedDataContextHandler = false;
            ...
            public void DataContextChangedHandler(global::Windows.UI.Xaml.FrameworkElement sender, global::Windows.UI.Xaml.DataContextChangedEventArgs args)
            {
                 global::SoundBoardApp.Model.Sound data = args.NewValue as global::SoundBoardApp.Model.Sound;
                 if (args.NewValue != null && data == null)
                 {
                    throw new global::System.ArgumentException("Incorrect type passed into template. Based on the x:DataType global::SoundBoardApp.Model.Sound was expected.");
                 }
                 this.SetDataRoot(data);
                 this.Update();
            }
            ...
            public int ProcessBindings(global::Windows.UI.Xaml.Controls.ContainerContentChangingEventArgs args)
            {
                ...
                switch(args.Phase)
                {
                    case 0:
                        nextPhase = -1;
                        this.SetDataRoot(args.Item as global::SoundBoardApp.Model.Sound);
                        if (!removedDataContextHandler)
                        {
                            removedDataContextHandler = true;
                ...
                this.Update_((global::SoundBoardApp.Model.Sound) args.Item, 1 << (int)args.Phase);
                return nextPhase;
            }
            ...
            public void SetDataRoot(global::SoundBoardApp.Model.Sound newDataRoot)
            {
                this.dataRoot = newDataRoot;
            }

            // Update methods for each path node used in binding steps.
            private void Update_(global::SoundBoardApp.Model.Sound obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::SoundBoardApp.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public void SetDataRoot(global::SoundBoardApp.MainPage newDataRoot)
            {
                this.dataRoot = newDataRoot;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::SoundBoardApp.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_MenuItems(global::System.Collections.Generic.List<global::SoundBoardApp.Model.MenuItem> obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_Sounds(global::System.Collections.ObjectModel.ObservableCollection<global::SoundBoardApp.Model.Sound> obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            case 4:
                {
                    ...
                    returnValue = bindings;
                    bindings.SetDataRoot((global::SoundBoardApp.Model.MenuItem) element4.DataContext);
            ...
            case 10:
                {
                    ...
                    returnValue = bindings;
                    bindings.SetDataRoot((global::SoundBoardApp.Model.Sound) element10.DataContext);
